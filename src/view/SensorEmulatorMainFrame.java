...
public class SensorEmulatorMainFrame extends EDTSafeFrame {
    ...
    private JPanel lidarPanel() {
        ...
        final JTextField positionX = new JTextField("0.0", 3);
        final JTextField positionY = new JTextField("0.0", 3);
        final JTextField positionZ = new JTextField("0.0", 3);
        panel.add(positionX);
        panel.add(positionY);
        panel.add(positionZ, "wrap");
        panel.add(new JLabel(new DirectI18N("Direction: ").toString()));
        final JTextField directionX = new JTextField("1.0", 3);
        final JTextField directionY = new JTextField("-1.0", 3);
        final JTextField directionZ = new JTextField("1.0", 3);
